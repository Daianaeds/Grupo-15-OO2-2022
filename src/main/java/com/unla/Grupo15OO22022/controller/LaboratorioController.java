...
import com.unla.Grupo15OO22022.service.implementation.LaboratorioService;
...
public class LaboratorioController {
	...
	@PostMapping("/Create")
	public RedirectView create(@ModelAttribute("laboratorio") LaboratorioModel laboratorioModel) {
		laboratorioService.insertOrUpdate(laboratorioModel);
